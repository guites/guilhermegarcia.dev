...
These are some of my favorite pages on the web.

They range from articles, tutorials, games, photography and other beautiful stuff.

Get surfing!

<video autoplay loop muted playsinline title="Surf!">
  <source src="surfchu.webm" type="video/webm">
  <source src="surfchu.mp4" type="video/mp4">
</video>
...
- [Python list implementation by Laurent Luce (2015)](https://www.laurentluce.com/posts/python-list-implementation/) and [How Python list works by Anton Zhiyanov (2021)](https://antonz.org/list-internals/)
- [Database Fundamentals by Tony Solomonik](https://tontinton.com/posts/database-fundementals/)
- [Jumblie](https://jumblie.com/)
- [Dwarf Fortress by ANDROID ARTS](https://www.androidarts.com/df/dorf.htm)
- [WebRTC For The Curious](https://webrtcforthecurious.com/)
- [TDungeon - adventure game that runs in the Typescript type system](https://github.com/cassiozen/TDungeon)
- [Every noise at Once (rip ⚰️)](https://everynoise.com/)
- [Cumbuca Dev](https://cumbuca.dev/)
- [The Nand Game](https://www.nandgame.com/)
- [Cognitive load is what matters by Artem Zakirullin](https://minds.md/zakirullin/cognitive)
